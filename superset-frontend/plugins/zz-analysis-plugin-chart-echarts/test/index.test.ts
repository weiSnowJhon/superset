 ...
 * under the License.
 */
import { ZzAnalysisPluginChartEcharts } from '../src/CardBigNumber/CardCompareNumber';
 ...
 */
describe('zz-analysis-plugin-chart-echarts', () => {
  it('exists', () => {
    expect(ZzAnalysisPluginChartEcharts).toBeDefined();
  });
});
